...
template <class T>
using TStaticFunctionPtr = typename TBaseStaticDelegateInstance<T, FDefaultTSDelegateUserPolicy>::FFuncPtr;
...
public:
	...
	TMap<FGameplayTag, TStaticFunctionPtr<FGameplayAttribute()>>
	TagsToAttributes;
